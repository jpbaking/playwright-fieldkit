# /record-flow — learn a journey from a user's browser demonstration
...
Inspect the existing E2E suite exactly as in `generate-tests.md`: determine its
...
node .cline/skills/playwright-fieldkit/scripts/record.mjs <URL> \
...
cleanup, and meaningful variants with the `create-test-charter` workflow. Then
