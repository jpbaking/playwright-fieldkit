# /analyze-test-coverage — find unautomated routes and forms
...
```bash
node .cline/skills/playwright-fieldkit/scripts/coverage.mjs report/explore tests/e2e --out report/coverage
```
