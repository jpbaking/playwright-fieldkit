...
`(cd .cline/skills/pw-playwright-fieldkit/scripts && npm install && npx playwright install chromium)` and stop until done.

## Step 2 — Crawl
```
node .cline/skills/pw-playwright-fieldkit/scripts/crawl.mjs <START_URL> --depth 2 --max-pages 40 --out report/explore
```
...
```
node .cline/skills/pw-playwright-fieldkit/scripts/inspect.mjs <THAT_URL> --wait 1500 --out report/inspect
```
