...
```bash
node .cline/skills/pw-playwright-fieldkit/scripts/crawl.mjs <START_URL> --depth 2 --max-pages 30 --out report/tests
```
...
`.cline/skills/pw-playwright-fieldkit/templates/flow.example.json` and prefer stable
